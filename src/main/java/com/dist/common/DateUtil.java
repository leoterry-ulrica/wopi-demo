...
public class DateUtil {
    ...
    public static int getDays(Date date1, Date date2) {
        ...
        double millis = DateUtil.strToDate(date1Str, DATE_FORMAT_STR).getTime()
                - DateUtil.strToDate(date2Str, DATE_FORMAT_STR).getTime();
    ...
    public static String[] getDateArrayByPeriod(String datePeriod) {
        if (!StringUtil.isNullOrEmpty(datePeriod)) {
